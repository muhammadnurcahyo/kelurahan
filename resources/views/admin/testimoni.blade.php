                ...
                <section class="section">
                    <div class="card">
                        <div class="card-header" style="padding-top: 40px; text-align: right; margin-right: -30px;">
                            <a href="{{URL::to('/admin/add/testimonial')}}">
                            ...
                            <table class="table table-striped table-hover" id="table1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="{{ asset('/images/testimonial/'.$t->img) }}" alt=""
                                                style="width: 100px; height: 100px;">
                                        </td>
                                        <td>
                                            <a href="{{URL::to('/admin/edit/testimonial/').'/'.$t->id}}">
                                                <button class="btn">
                                                    <i class="bi bi-pencil-square"></i>
                                                </button>
                                            </a>
                                            
                                                <form  action="{{URL::to('/admin/delete/testimonial/').'/'.$t->id}}" method="post">
                                                {{@csrf_field()}}
