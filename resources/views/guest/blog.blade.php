            ...
            <div class="col-md-9 col-sm-12 width70">
                ...
                <div class="blog_post_se1c">
                    ...
                    <blockquote>
                        ...
                        <li style="margin-top: -10px; margin-left: 15px;">
                            <a href="{{ route('blog.show',$s->slug) }}" style="font-style: italic;" target="_blank">
                                {{$s->title}}
                            </a>
                            <br>
                        </li>
                ...
                <div>
                    ...
                    <div class="diskusi border-top">
                        ...
                        <div>
                            <p style="font-size: 12px; color: darkslateblue;" class="komen">
                                {{date('d-M-Y', strtotime($com->created_at));}}</p>
                        </div>
                        <div class="komen">
                            <p>{{$com->comment}}</p>
                        </div>
