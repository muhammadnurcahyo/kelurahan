...
Route::middleware(['isloggedin'])->group(function () {
    ...
    Route::get('/admin/categories/add', [CategoriesController::class, 'create'])->name('categories.create');
    Route::get('/admin/categories/edit/{id}', [CategoriesController::class, 'update'])->name('categories.edit');
    Route::post('/admin/categories/add', [CategoriesController::class, 'store'])->name('categories.store');
    Route::put('/admin/categories/edit/{id}', [CategoriesController::class, 'edit'])->name('categories.update');
...
Route::get('/berita/{slug}', [BlogsController::class, 'guest'])->name('blog.show');
